    ...
    <div
        ...
        <a
            ...
            class="
                    ...
                    rounded-xl border border-[#008080]
                    px-4 py-2.5
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    <tr class="transition hover:bg-gray-50/70 dark:hover:bg-gray-800/40">
                        ...
                        <td class="px-5 py-4">
                            ...
                            <div class="flex min-w-[260px] items-center gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="max-w-xs truncate text-sm font-medium text-gray-900 dark:text-white">
                        ...
                        {{-- Display Order --}}
                        <td class="px-5 py-4 text-center text-sm font-medium text-gray-700 dark:text-gray-300">
                            {{ $slide->display_order }}
                        </td>
                        ...
                        <td class="px-5 py-4 text-center">
                            ...
                            $statusClasses = 'bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400';
                            $dotClasses = 'bg-neutral-400';
                            } elseif ($slide->starts_at && $slide->starts_at->isFuture()) {
                            $slideStatus = 'Scheduled';
                            $statusClasses = 'bg-blue-50 text-blue-700 dark:bg-blue-950/40 dark:text-blue-300';
                            $dotClasses = 'bg-blue-500';
                            } elseif ($slide->ends_at && $slide->ends_at->isPast()) {
                            $slideStatus = 'Expired';
                            $statusClasses = 'bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-300';
                            $dotClasses = 'bg-amber-500';
                            } else {
                            $slideStatus = 'Published';
                            $statusClasses = 'bg-green-50 text-green-700 dark:bg-green-950/40 dark:text-green-300';
