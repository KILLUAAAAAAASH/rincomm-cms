    ...
    <div class="rounded-xl border border-red-200 bg-red-50 p-4
        ...
        <div class="flex gap-3">
            <i data-lucide="circle-alert"
               class="mt-0.5 h-5 w-5 shrink-0 text-red-600"></i>
            ...
            <div class="mt-5 space-y-5">
                ...
                <div>
                    ...
                    <select
                        ...
                        class="w-full rounded-xl border border-gray-300
                               ...
                               outline-none transition focus:border-[#008080]
                ...
                <div data-hero-text-field>
                    ...
                    <textarea
                        ...
                        class="w-full resize-y rounded-xl border border-gray-300
                               bg-white px-3.5 py-2.5 text-sm text-gray-900
                               outline-none transition focus:border-[#008080]
                               focus:ring-2 focus:ring-[#008080]/20
                               dark:border-gray-700 dark:bg-gray-800
                ...
                {{-- CTA Fields --}}
                <div data-hero-cta-fields class="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="block w-full rounded-xl border border-gray-300
                               ...
                               file:px-4 file:py-3 file:text-sm
                               file:font-medium file:text-gray-700
                               dark:border-gray-700 dark:bg-gray-800
                               dark:text-gray-300 dark:file:bg-gray-700
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div>
                        ...
                        <label class="relative inline-flex cursor-pointer items-center">
                            ...
                            <span class="h-6 w-11 rounded-full bg-gray-300
                                         transition after:absolute after:left-[2px]
