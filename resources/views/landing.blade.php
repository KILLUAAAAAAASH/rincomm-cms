        ...
        <div
            ...
            <div>
                ...
                <h2
                    class="
                        ...
                        sm:text-4xl
                    ">
                    Internet service with easier customer access
                </h2>
            </div>
            ...
            <div>
                <p class="text-base leading-7 text-slate-600">
                    Rincomm Internet Services provides internet connectivity
                    and customer support for its subscribers. Customers can
                    check service availability, view available plans, manage
                    their account, and access support through the Rincomm
                    online system.
                </p>

                <p class="mt-4 text-base leading-7 text-slate-600">
                    The system helps make applications, billing, payments,
                    service requests, and customer support easier to access
                    and manage online.
                </p>
            </div>
