    ...
    <main class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-start justify-between gap-4">
            ...
            <button
                type="button"
                data-theme-toggle
                class="inline-flex h-11 w-11 shrink-0 items-center justify-center border border-neutral-300 bg-white text-neutral-700 transition hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-[#008080] dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800"
                aria-label="Switch theme">
                <i
                    data-lucide="sun"
                    data-theme-sun-icon
                    class="hidden h-5 w-5"></i>
        ...
        <div
            role="status"
            class="mb-6 flex items-start gap-3 border border-emerald-300 bg-emerald-50 px-4 py-3 text-sm text-emerald-900 dark:border-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-200">
            <i
        ...
        {{-- Application Context --}}
        <section
            class="mb-6 border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 sm:p-6">
            <div class="mb-5">
        ...
        <form
            ...
            <div
                role="alert"
                class="flex items-start gap-3 border border-red-300 bg-red-50 px-4 py-3 text-sm text-red-800 dark:border-red-900 dark:bg-red-950/40 dark:text-red-200">
                <i
            ...
            <section
                class="border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 sm:p-6">
                <div class="mb-6">
                    <h2 class="text-lg font-semibold text-neutral-950 dark:text-white">
                        Applicant Information
                    </h2>
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="block min-h-11 w-full bg-white px-4 py-3 text-base text-neutral-950 outline-none transition
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="block min-h-11 w-full bg-white px-4 py-3 text-base text-neutral-950 outline-none transition placeholder:text-neutral-400
                        {{ $errors->has('phone')
                            ? 'border border-red-500 ring-1 ring-red-500/20 focus:border-red-500 focus:ring-red-500'
                            : 'border border-neutral-300 focus:border-[#008080] focus:ring-1 focus:ring-[#008080] dark:border-neutral-700'
                        }}
            ...
            <section
                ...
                <div
                    class="mb-5 bg-neutral-50 px-4 py-3 text-sm text-neutral-700 dark:bg-neutral-950 dark:text-neutral-300">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="block w-full resize-y bg-white px-4 py-3 text-base text-neutral-950 outline-none transition placeholder:text-neutral-400
                    {{ $errors->has('installation_address')
                        ? 'border border-red-500 ring-1 ring-red-500/20 focus:border-red-500 focus:ring-red-500'
                        : 'border border-neutral-300 focus:border-[#008080] focus:ring-1 focus:ring-[#008080] dark:border-neutral-700'
                    }}
                    dark:bg-neutral-950 dark:text-white dark:placeholder:text-neutral-500">{{ old('installation_address') }}</textarea>
            ...
            <section
                ...
                <div>
                    ...
                    dark:bg-neutral-950 dark:text-white dark:placeholder:text-neutral-500">{{ old('billing_address') }}</textarea>
            ...
            <div
                class="border border-neutral-200 bg-neutral-50 px-4 py-3 text-sm leading-6 text-neutral-600 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-400">
            ...
            {{-- Actions --}}
            <div
                class="flex flex-col-reverse gap-3 border-t border-neutral-200 pt-6 dark:border-neutral-800 sm:flex-row sm:items-center sm:justify-between">
                <a
                    href="{{ route('customer.dashboard') }}"
                    class="inline-flex min-h-11 items-center justify-center gap-2 border border-neutral-300 bg-white px-5 py-3 text-sm font-semibold text-neutral-800 transition hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-[#008080] dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800">
                    <i
                ...
                <button
                    type="submit"
                    class="inline-flex min-h-11 items-center justify-center bg-[#008080] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#006666] focus:outline-none focus:ring-2 focus:ring-[#008080] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 dark:focus:ring-offset-neutral-950">
                    Submit Application
                </button>
            </div>
