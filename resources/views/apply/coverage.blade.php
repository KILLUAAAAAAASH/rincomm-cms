...
<body class="min-h-screen bg-neutral-100 text-neutral-900 transition-colors dark:bg-neutral-950 dark:text-neutral-100">
    ...
    <button
        type="button"
        data-theme-toggle
        class="fixed right-4 top-4 z-30 inline-flex h-11 w-11 items-center justify-center rounded-xl border border-neutral-300 bg-white text-neutral-600 shadow-sm transition hover:border-[#008080] hover:text-[#008080] focus:outline-none focus:ring-2 focus:ring-[#008080] dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300 dark:hover:border-teal-400 dark:hover:text-teal-400 sm:right-6 sm:top-6"
    ...
    <main class="mx-auto min-h-screen max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        @if ($selectedPlan)
        <section
            class="mb-6 rounded-2xl border border-[#008080]/30 bg-[#008080]/5 p-5 dark:border-teal-500/30 dark:bg-teal-500/10"
                ...
                <form
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="block min-h-12 w-full rounded-xl bg-white px-4 py-3 text-base text-neutral-950 outline-none transition placeholder:text-neutral-400
                                    {{ $errors->has('province')
                    ...
                    <div class="rounded-xl bg-neutral-50 p-4 text-sm text-neutral-700 dark:bg-neutral-950 dark:text-neutral-300">
                        <div class="flex gap-3">
                            <i
                                data-lucide="map-pin"
                                class="mt-0.5 h-5 w-5 shrink-0 text-[#008080] dark:text-teal-400"></i>
    ...
    ">
                    <div
                        ...
                        role="region"
                        aria-label="Rincomm service coverage map"></div>

                    @if ($coverageAreas->isEmpty())
                    <div
                        id="coverage-map-empty"
                        class="pointer-events-none absolute inset-x-4 bottom-4 z-[500] rounded-xl border border-neutral-200 bg-white/95 px-4 py-3 shadow-sm backdrop-blur-sm dark:border-neutral-700 dark:bg-neutral-900/95">
                        <div class="flex items-start gap-3">
                            <i
                                data-lucide="map-pinned"
                                class="mt-0.5 h-5 w-5 shrink-0 text-neutral-500 dark:text-neutral-400"></i>
        ...
        <p class="mt-6 text-center text-sm text-neutral-600 dark:text-neutral-400">
            ...
            <a
                href="{{ route('login') }}"
                class="font-semibold text-[#008080] underline underline-offset-4 transition hover:text-[#006666] dark:text-teal-400 dark:hover:text-teal-300">
                Sign In
            </a>
        </p>
